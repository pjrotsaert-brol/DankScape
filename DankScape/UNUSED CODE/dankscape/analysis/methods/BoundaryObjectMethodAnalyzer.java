 ...
 */
public class BoundaryObjectMethodAnalyzer extends AbstractMethodAnalyzer {

    public BoundaryObjectMethodAnalyzer() {
        this.setId("BoundaryObject");
    ...
    public void identify() {
        ...
        for (ClassNode c : getClasses().values()) {
            method = getMethod(c, true, "(IIIIL" + getOther("Renderable").getName() +
                    ";L" + getOther("Renderable").getName() + ";IIII)V");
            if (method != null)
                break;
        }
